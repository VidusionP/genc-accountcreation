...
export default class Auth extends PageManager {
    ...
    registerCreateAccountValidator($createAccountForm) {
        ...
        const addressSelector = `${this.formCreateSelector} [data-field-type='AddressLine1']`
        const $addressElement = $(addressSelector)
        const citySelector = `${this.formCreateSelector} [data-field-type='City']`
        const $cityElement = $(citySelector)
        const zipSelector = `${this.formCreateSelector} [data-field-type='Zip']`
        const $zipElement = $(zipSelector)
        const countrySelector = `${this.formCreateSelector} [data-field-type='Country']`
        const $countryElement = $(countrySelector)
