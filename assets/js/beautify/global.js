...
export default function (context) {
    ...
    const $headerAnnouncement = $('[id^=sd-simple-text-editable').length>0 ? $('[id^=sd-simple-text-editable').children().first() : null;
    ...
    if ($headerAnnouncement) {
        $headerAnnouncement.addClass('headerAnnouncement');
    }
